...
public class genMiniIRVisitor<R> implements GJNoArguVisitor<R> {
     ...
     * -> "}"
     */
    public R visit(MethodDeclaration n) { // not done - a global temp_count
        R _ret = null;
        ...
        temp_count = param_no + 1 + curr_method.locals.size();
...
/**
    ...
    */
    ...
    public R visit(MessageSend n) {
        ...
        ListIterator itr = param_queue.listIterator();
        while (itr.hasNext()) {
    ...
    public R visit(ExpressionList n) {
        ...
        param_queue.add("TEMP " + param_temp);
